...
CESTER_TEST(xvector_iterator_advance_by, _, {
    xvector(str) *fruits;
    enum x_stat status;
    XIterator *iterator;
...
CESTER_TEST(xvector_iterator_increment_decrement, _, {
    xvector(str) *fruits;
    enum x_stat status;
    XIterator *iterator;
...
CESTER_TEST(xvector_iterator_segfault, _, {
    xvector(str) *fruits;
    enum x_stat status;
    XIterator *iterator;
...
CESTER_TEST(xvector_iterator_forward_and_backward, _, {
    xvector(str) *fruits;
    enum x_stat status;
    ...
    index = 0;
    forward_iterator = XITERATOR_INIT(xvector, str, fruits);
    backward_iterator = XITERATOR_INIT(xvector, str, fruits);
...
CESTER_OPTIONS(
    CESTER_TEST_SHOULD_FAIL(xvector_iterator_segfault);
